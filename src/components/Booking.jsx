  ...
  return (
    <section id="booking" className="bg-white text-black py-20">
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-4xl md:text-5xl font-serif font-black mb-10">Afspraken boeken</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="rounded-2xl border border-black/10 p-6 bg-neutral-50">
      ...
      <a href="#booking" className="fixed right-4 bottom-4 z-50 px-5 py-3 rounded-full font-bold shadow-lg border border-black/10 bg-black text-white hover:bg-neutral-900 transition">
        Boek nu
      </a>
    </section>
  );
